...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final next = MockData.appointments
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  ServiceCard(
                    ...
                    label: 'Check-in',
                    onTap: () => _showSnack(context, 'Check-in via QR Code'),
                  ),
                  ServiceCard(
                    icon: Icons.local_hospital_outlined,
                    label: 'Convenios',
                    onTap: () => _showSnack(context, 'Convenios aceitos'),
                  ),
                  ServiceCard(
                    icon: Icons.payment_outlined,
                    label: 'Pagamentos',
                    onTap: () => _showSnack(context, 'Historico de pagamentos'),
                  ),
                  ServiceCard(
                    icon: Icons.support_agent_outlined,
                    label: 'Atendimento',
                    onTap: () => _showSnack(context, 'Fale com a gente'),
                  ),
                  ServiceCard(
                    icon: Icons.more_horiz,
                    label: 'Mais',
                    onTap: () => _showSnack(context, 'Mais servicos'),
                  ),
                ],
              ),
            ),
